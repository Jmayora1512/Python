...
class Client (object):
    ...
    def __init__(self, api_key=2162d516bbf6eba42222e4b7e2cfe4ca05274c1c26fd781db3396a831b17ef90, client_type='json'):
...
def main():
    ...
    device = "defaultDevice@jmayora.jmayora"  # Replace with the id_developer of your device
    apikey = "2162d516bbf6eba42222e4b7e2cfe4ca05274c1c26fd781db3396a831b17ef90"  # Replace with your Carriots apikey
